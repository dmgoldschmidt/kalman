...
\appendix
\section{A Standard Form for Orthonormal Matrices}
...
re-ordering of the eigenvalues, then $W^tAW$ is a block diagonal matrix whose entries are either $\pm 1$
or $2\times 2$ rotation matrices.
