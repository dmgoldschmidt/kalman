...
\begin{align*}
  ...
  \Sigma_{b,t} :&= \Sigma_{Ob}\widehat{\Sigma}_t^{-1}\Sigma_{b,t+1} + \Sigma_{Tr},\quad\text{and}\\
...
\begin{proof}
  ...
  \begin{align*}
    ...
    &= Q_{t+1}\N(x_t;\mu_{b,t+1},\widehat{\Sigma}_t)\N(u;\mu_{b,t},\widetilde{\Sigma}_t),\quad\text{where}\\
